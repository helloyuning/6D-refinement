...
def generator(pb_file,detection_graph):
...
if __name__ == '__main__':
    ...
    #convert_pb_to_pbtxt(frozen_path)#节点编辑的函数

    # new_graph = generator(frozen_path,detection_graph)
    # print(new_graph.get_operations())#所有冻结节点替换为 原名称+turn_var的形式
    # original_graph = old_graph(frozen_path, detection_graph)#查看原始graph
    # print(original_graph.get_operations())
    #属性： <tf.Operation 'InceptionV4/Mixed_5d/Branch_2/Conv2d_0c_3x3/BatchNorm/moving_variance_turned_var' type=VariableV2>
