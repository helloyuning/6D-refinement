...
Options:
    ...
    -r --max_rot_pert=<float>    Max. Rotational Perturbation to be applied in Degrees [default: 20.0]#20
    -t --max_trans_pert=<float>  Max. Translational Perturbation to be applied in Meters [default: 0.10]#0.10
...
with tf.Session() as session:
    ...
    #print("bench.frams:",len(bench.frames))
